                    ...
                    <div class="news-standard-wrapper">
                        <div class="news-standard-items">
                            ...
                            <div class="news-content">
                                ...
                                <h3>
                                    <a href="{{ url('/news-details') }}">Top 10 Tarot Decks For The Tarot world Summit</a>
                                </h3>
                                <p>
                                ...
                                <a href="{{ url('/news-details') }}" class="theme-btn mt-4">
                                    Read More
                        ...
                        <div class="news-standard-items">
                            ...
                            <div class="news-content">
                                ...
                                <h3>
                                    <a href="{{ url('/news-details') }}">Eu parturient dictumst fames quam tempor</a>
                                </h3>
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris efficitur et ipsum
                                    ut volutpat. Morbi a mollis felis. Nam consectetur lectus vel lorem facilisis, quis
                        ...
                        <div class="news-standard-items">
                            ...
                            <div class="news-content">
                                ...
                                <h3>
                                    <a href="{{ url('/news-details') }}">All Inclusive Ultimate Circle Island Day with Lunch </a>
                                </h3>
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris efficitur et ipsum
                                    ut volutpat. Morbi a mollis felis. Nam consectetur lectus vel lorem facilisis, quis
                        ...
                        <div class="page-nav-wrap text-center">
                            <ul>
                                <li><a class="previous" href="{{ url('/news') }}">Previous</a></li>
                                <li><a class="page-numbers" href="{{ url('/news') }}">1</a></li>
                                <li><a class="page-numbers" href="{{ url('/news') }}">2</a></li>
                                <li><a class="page-numbers" href="{{ url('/news') }}">3</a></li>
                                <li><a class="page-numbers" href="{{ url('/news') }}">...</a></li>
                                <li><a class="next" href="{{ url('/news') }}">Next</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
